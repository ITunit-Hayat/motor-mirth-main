...
import { Route as PostCarRouteImport } from './routes/post-car'
...
const PostCarRoute = PostCarRouteImport.update({
  id: '/post-car',
  path: '/post-car',
  getParentRoute: () => rootRouteImport,
} as any)
...
export interface RootRouteChildren {
  ...
  PostCarRoute: typeof PostCarRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/post-car': {
      ...
      path: '/post-car'
      fullPath: '/post-car'
      preLoaderRoute: typeof PostCarRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/sell': {
      id: '/sell'
