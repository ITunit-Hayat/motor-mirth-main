...
const D: Dict = {
  ...
  navPostCar: { en: "Post Your Car", ar: "انشر إعلانك", fr: "Déposer une annonce" },
  myAccount: { en: "My Account", ar: "حسابي", fr: "Mon compte" },
  myListings: { en: "My Listings", ar: "إعلاناتي", fr: "Mes annonces" },
  loginOrRegister: { en: "Sign In / Register", ar: "تسجيل الدخول / إنشاء حساب", fr: "Connexion / Inscription" },
  logout: { en: "Sign Out", ar: "تسجيل الخروج", fr: "Se déconnecter" },
  directCall: { en: "Call Showroom", ar: "اتصال بالمعرض", fr: "Appeler le showroom" },
  whatsappChat: { en: "WhatsApp", ar: "واتساب", fr: "WhatsApp" },
  themeLight: { en: "Light", ar: "فاتح", fr: "Clair" },
  themeDark: { en: "Dark", ar: "داكن", fr: "Sombre" },
  menuTitle: { en: "Navigation Menu", ar: "قائمة التنقل", fr: "Menu de navigation" },
  quickActions: { en: "Quick Actions", ar: "إجراءات سريعة", fr: "Actions rapides" },
  preferences: { en: "Preferences", ar: "التفضيلات", fr: "Préférences" },
  showroomInfo: { en: "Showroom", ar: "المعرض", fr: "Showroom" },
