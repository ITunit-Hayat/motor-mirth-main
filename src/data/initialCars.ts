export type CarStatus =
  "Active" | "Draft" | "Reserved" | "Sold" | "PendingReview";
...
export type Car = {
  ...
  /** Set only for listings posted by a member (not the dealership's own stock). */
  sellerId?: string;
  sellerName?: string;
  sellerPhone?: string;
  wilaya?: string;
  commune?: string;
  /** ISO timestamp: when the poster accepted the seller declaration/terms. */
...
export const initialCars: Car[] = [
  ...
  },
  {
    ...
    fuel: "Petrol",
    description:
      "Refined luxury SUV with commanding presence and exceptional on-road manners.",
    images: [
      "https://images.unsplash.com/photo-1618843479313-40f8afb4b4d8?w=1600&q=80",
  ...
  },
  {
    ...
    fuel: "Petrol",
    description:
      "Top-tier Lexus flagship with peerless build quality and whisper-quiet cabin.",
    images: [
  ...
  },
  {
    ...
    images: [
      "https://images.unsplash.com/photo-1591293836027-e05b48473b67?w=1600&q=80",
    ],
    featured: false,
    discount: 7,
  },
