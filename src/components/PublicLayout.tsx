        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 py-10 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="mt-3 space-y-1.5 text-sm">
              ...
              <li><Link to="/sell" className="hover:text-accent">{t("navSellCar")}</Link></li>
          ...
          <div>
            ...
            <ul className="mt-3 space-y-1.5 text-sm">
              ...
              <li><Link to="/admin" className="hover:text-accent font-semibold text-accent">{t("navAdmin")} / لوحة الإدارة</Link></li>
            </ul>
          </div>
          <div>
