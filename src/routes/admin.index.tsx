...
function AdminHome() {
  ...
  return (
    <AdminLayout>
      ...
      <div className="mt-6 grid gap-3 sm:gap-4 grid-cols-1 xs:grid-cols-2 lg:grid-cols-3">
        {stats.map((s) => (
          <div key={s.label} className="bg-card border border-border rounded-2xl p-4 sm:p-5 shadow-card">
            ...
            <div className="mt-2 text-lg sm:text-2xl font-display font-bold leading-tight break-words">{s.value}</div>
          </div>
        ))}
      </div>
      ...
      <div className="mt-6 bg-card border border-border rounded-2xl p-5 shadow-card">
        ...
        {topCars.length === 0 ? (
          ...
          <div className="mt-4 grid gap-2 sm:gap-3 grid-cols-1 xs:grid-cols-2 lg:grid-cols-5">
      ...
      <div className="mt-8 grid gap-3 sm:gap-4 grid-cols-1 xs:grid-cols-2 lg:grid-cols-4">
        <Link
          to="/admin/cars"
          className="bg-card border border-border rounded-xl p-4 sm:p-5 hover:shadow-card transition flex items-center justify-between"
        >
          <div className="flex items-center gap-3">
            <Car className="h-5 w-5 text-accent shrink-0" />
            <div className="min-w-0">
              <div className="font-semibold text-sm">إدارة المخزون</div>
              <div className="text-xs text-muted-foreground mt-0.5 hidden sm:block">إضافة وتعديل السيارات</div>
            </div>
          </div>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <div className="text-xs text-muted-foreground mt-0.5 hidden sm:block">متابعة العملاء والصفقات</div>
            </div>
          </div>
          <ArrowLeft className="h-4 w-4 text-muted-foreground shrink-0" />
        </Link>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <div className="text-xs text-muted-foreground mt-0.5 hidden sm:block">تخصيص الفئات والسمات</div>
            </div>
          </div>
          <ArrowLeft className="h-4 w-4 text-muted-foreground shrink-0" />
        </Link>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <div className="text-xs text-muted-foreground mt-0.5 hidden sm:block">بيانات التواصل والعملة</div>
            </div>
          </div>
          <ArrowLeft className="h-4 w-4 text-muted-foreground shrink-0" />
        </Link>
