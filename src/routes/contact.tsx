        ...
        <div className="grid gap-8 lg:grid-cols-2 items-start">
          <div className="bg-card border border-border rounded-2xl shadow-elegant p-6 md:p-8">
            ...
            {sent ? (
              ...
              <form onSubmit={onSubmit} className="mt-8 space-y-5">
                ...
                >
                  {busy ? (
                    <span className="spin inline-block h-4 w-4 border-2 border-white/60 border-t-white rounded-full" />
                  ) : (
          ...
          <div className="space-y-4">
            {[
              ...
              >
                <div className="h-12 w-12 grid place-items-center rounded-xl bg-accent/15 text-accent">
