  ...
  return (
    <PublicLayout>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 pt-20 pb-14 sm:pt-32 sm:pb-24 text-white">
          <motion.div
          ...
          <motion.h1
            ...
            className="mt-5 font-display text-3xl sm:text-5xl lg:text-6xl font-bold leading-[1.1] max-w-3xl drop-shadow-xl text-white"
          >
            {t("heroTitle")}
          </motion.h1>
          ...
          <motion.form
            ...
            className="mt-6 sm:mt-8 relative w-full max-w-2xl"
          >
            <div className="flex flex-col xs:flex-row items-stretch xs:items-center gap-2 bg-card/95 backdrop-blur-md border border-accent/30 text-foreground rounded-2xl shadow-elegant p-2 sm:p-2.5">
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                type="submit"
                className="inline-flex items-center justify-center gap-2 h-11 px-4 sm:px-6 rounded-lg bg-gradient-accent text-accent-foreground font-bold text-sm whitespace-nowrap shadow-md cursor-pointer w-full xs:w-auto"
              >
                {t("heroSearchBtn")}{" "}
          ...
          <motion.div
            ...
            className="mt-8 sm:mt-10 grid grid-cols-3 w-full max-w-xs sm:max-w-lg gap-3 sm:gap-6"
          >
            {[
              ["0", t("statCars")],
              ["0%", t("statDrivers")],
              ...
              <motion.div
                ...
                className="p-2.5 sm:p-3.5 rounded-xl bg-card/60 border border-border/60 backdrop-blur-sm shadow-card"
              >
                <div className="text-xl sm:text-2xl md:text-3xl font-display font-bold text-accent">
                  {k}
                </div>
                <div className="text-[10px] sm:text-xs md:text-sm text-white/90 font-medium mt-0.5 leading-tight">{v}</div>
              </motion.div>
            ))}
          </motion.div>
        </div>
          ...
          {Object.entries(CATEGORY_META).map(([cat, m], index) => (
            ...
            >
              <Link
                ...
                search={{ category: cat }}
                className={cn(
                  "group block h-full rounded-2xl p-4 sm:p-5 text-center border border-border bg-card hover:border-accent/50 hover:shadow-elegant transition-all duration-300 bg-gradient-to-br",
                  m.tone,
                )}
              >
                <div className="text-3xl sm:text-4xl mb-2 group-hover:scale-115 transition-transform duration-300">
                  {m.icon}
                </div>
                <div className="font-semibold text-xs sm:text-sm text-white leading-tight">{cat}</div>
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 py-8">
        ...
        <div className="flex gap-4 sm:gap-5 overflow-x-auto no-scrollbar scroll-snap-x pb-4 -mx-4 px-4">
          {featured.map((c, i) => (
            <motion.div
              key={c.id}
              ...
              className="min-w-[260px] xs:min-w-[290px] sm:min-w-[340px] snap-start"
            >
              <CarCard car={c} />
            </motion.div>
          ))}
      ...
      <section className="relative mt-10 overflow-hidden border-y border-border">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 py-12 sm:py-20 text-white">
      ...
      <section className="relative overflow-hidden bg-gradient-hero text-primary-foreground border-t border-border">
        ...
        >
          ...
          <div className="mt-7 flex items-center justify-center gap-3 flex-wrap px-4">
