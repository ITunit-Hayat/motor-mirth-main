...
//#region node_modules/.nitro/vite/services/ssr/assets/LanguageContext-C6BSyEfd.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_dev_runtime = require_jsx_dev_runtime();
var _jsxFileName = "/app/applet/src/context/LanguageContext.tsx";
var D = {
	brand: {
		en: "VelocityMotors",
		ar: "فيلوسيتي موتورز",
	...
	aboutHeroBody: {
		...
		ar: "انطلقنا من صالة عرض واحدة في وسط لوس أنجلوس لنصبح أحد أكثر الأسماء الموثوقة في تجارة السيارات الفاخرة. فكرة بسيطة: معاملة كل عميل كصديق لا كصفقة. اليوم نخدم آلاف السائقين سنوياً بمخزون منتقى من السيارات الفاخرة والرياضية واليومية، كل سيارة مفحوصة، بسعر عادل، وبدعم مدى الحياة.",
		fr: "Parti d'un seul showroom à Los Angeles, VelocityMotors est devenu une référence. Traiter chaque acheteur comme un ami. Aujourd'hui nous servons des milliers de conducteurs — inventaire sélectionné, inspecté, juste prix, support à vie."
	},
	aboutMissionTitle: {
		en: "Our mission",
		ar: "رسالتنا",
	...
	contactLocationVal: {
		en: "Grand Ave, Los Angeles, CA 90015",
		ar: "شارع جراند، لوس أنجلوس، كاليفورنيا 90015",
		fr: "Grand Ave, Los Angeles, CA 90015"
	},
	contactSent: {
		en: "Message sent!",
		ar: "تم إرسال رسالتك!",
...
function LanguageProvider({ children }) {
	const [locale, setLocaleState] = (0, import_react.useState)(detectInitial);
	...
	return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(LanguageContext.Provider, {
		value,
		children
	}, void 0, false, {
...
function useLanguage() {
	const c = (0, import_react.useContext)(LanguageContext);
