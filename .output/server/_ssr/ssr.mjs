...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BwgcFcLS.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-CY3XD-g8.mjs"),
		import("./start-BKuld8x0.mjs"),
...
//#endregion
export { server_default as default, createCsrfMiddleware as n, createStart as t };
